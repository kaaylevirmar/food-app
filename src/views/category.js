        ...
        <div className="fixed bg-slate-950/50 w-screen h-screen rounded drop-shadow-lg randomInfo">
          <div className="p-5 w-9/12 h-[42rem] bg-orange-300 foodInfo mb-1 pt-12 overflow-auto pb-10">
            <div className="flex justify-center">
              ...
              <button onClick={()=>{setIsOpen(false)}} className='border border-black  top-4 right-4 rounded-lg hover:bg-orange-600 hover:text-white   hover:rounded-lg bg-orange-500 font-bold absolute'>Close </  button>
            </div>
            <div className="flex justify-center">
